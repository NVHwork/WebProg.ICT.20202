...
<body>
    ...
    <form action="<?php echo $_SERVER["PHP_SELF"] ?>" method="POST">
		<br>
		<div>
			<label for="name1">First full name is:</label>
		...
		<div>
			...
			<input type="number" name="month1" required style="width: 40px;" value="<?php
																					...
																					?>" min=1 max=12>
			/
			<input type="number" name="year1" required style="width: 50px;" value="<?php
		...
		<br><br>
		<div>
			<label for="name2">Second full name is:</label>
		...
		<div>
			...
			<input type="number" name="month2" required style="width: 40px;" value="<?php
																					...
																					?>" min=1 max=12>
			/
			<input type="number" name="year2" required style="width: 50px;" value="<?php
