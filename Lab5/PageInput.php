            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="content" id="" class="form-control" cols="30" rows="10" placeholder="Input your page content"></textarea>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
                    <div class="form-group">
                        ...
                        <input type="color" class="form-control" id="" name="theme-color" value="#878787">
                    </div>
